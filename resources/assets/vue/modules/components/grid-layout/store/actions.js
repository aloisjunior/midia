...
export const addTitleGridItem = ({commit, state}, payload) => {
  let g = lib.guid()
  let k = { 'x': 0, 'y': 0, 'w': 400, 'h': 50, 'i': g, 'type': 'title', 'title': 'Heading 1', 'headings': { 'h1': false, 'h2': false, 'h3': false } }
...
export const addContentGridItem = ({commit, state}, payload) => {
  let g = lib.guid()
  let k = { 'x': 0, 'y': 0, 'w': 400, 'h': 100, 'i': g, 'type': 'content', 'content': 'Content goes here' }
  commit('setNewGridItem', k)
}

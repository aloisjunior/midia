<template>
    <div>
        <div class="heading-title heading-border heading-color mt-0">
            <h1 class="fs-18 fw-400">ENTRE EM CONTATO</h1>
            <p class="fs-13">ENVIE O FORMULÁRIO E NOS DIGA COMO AJUDAR</p>
        </div>
        <h1 class="fs-16">
            Estamos aguardando seu contato, que é muito importante para nós, temos certeza que podemos
            ajudar com qualquer serviço ou produto na área de tecnologia e comunicação, nosso portifólio é
            bem vasto.
        </h1>
        ...
        <div>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button @click.prevent="sendPost()" class="btn btn-primary">
                            <span>
...
//                        console.log('sucesso rodando update');
